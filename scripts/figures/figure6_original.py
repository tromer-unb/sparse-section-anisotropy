...
Monte-Carlo reconstruction. It only reads the final CSV outputs already produced
for the two rocks and extracts one representative 512x512 raw slice per rock.

Expected inputs
---------------
Bentheimer (same folder as this script by default):
  bentheimer_final_subvolumes.csv
  bentheimer_final_summary.csv
  kocurek_15a_2p25um_ir_rec_2500x2500x2500_binary_ROI-1.raw

Edwards Brown (default absolute path):
  .../EdwardsBrown_EdB1/ROI1/final_validation/edb1_final_subvolumes.csv
  .../EdwardsBrown_EdB1/ROI1/final_validation/edb1_final_summary.csv
  .../EdwardsBrown_EdB1/ROI1/edb-1_..._binary_ROI-1.raw
...
# Put this script in the same folder where the Bentheimer final-validation CSVs
# were generated. If you move them, change BENTHEIMER_DIR only.
BENTHEIMER_DIR = HERE

# Edwards Brown final-validation directory created by real_edb1_final_validation.py
EDB1_DIR = Path(
    "/home/tromer/Isarael/pushforward/data/real_rocks/"
    "EdwardsBrown_EdB1/ROI1/final_validation"
)

# RAW files are used ONLY for panel (a); all quantitative panels use final CSVs.
BENTHEIMER_RAW = BENTHEIMER_DIR / (
    "kocurek_15a_2p25um_ir_rec_2500x2500x2500_binary_ROI-1.raw"
)
EDB1_RAW = Path(
    "/home/tromer/Isarael/pushforward/data/real_rocks/"
    "EdwardsBrown_EdB1/ROI1/"
    "edb-1_2p25um_ir_rec_2500x2500x2500_binary_ROI-1.raw"
)

BENT_SUBVOL = BENTHEIMER_DIR / "bentheimer_final_subvolumes.csv"
BENT_SUMMARY = BENTHEIMER_DIR / "bentheimer_final_summary.csv"
EDB_SUBVOL = EDB1_DIR / "edb1_final_subvolumes.csv"
EDB_SUMMARY = EDB1_DIR / "edb1_final_summary.csv"
